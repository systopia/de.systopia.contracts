 ...
 */
class CRM_Contract_Monitoring_ActivityMonitor extends CRM_Contract_Monitoring_EntityMonitor {
  ...
  public static function processPreHook($op, $entity_id, &$params) {
    CRM_Contract_Monitoring_EntityMonitor::processPreHook(CRM_Contract_Monitoring_ActivityMonitor, $op, $entity_id, $params);
  }

  public static function processPostHook($op, $entity_id, $objectRef) {
    CRM_Contract_Monitoring_EntityMonitor::processPostHook(CRM_Contract_Monitoring_ActivityMonitor, $op, $entity_id, $objectRef);
  }
